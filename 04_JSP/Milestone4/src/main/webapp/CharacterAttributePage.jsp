...
<body>
	<div class="container">
		...
		<h2>${attributes[0].character.firstName}
			${attributes[0].character.lastName}'s Attributes</h2>
		...
		<table id="myTable">
			...
			<tbody>
				<c:forEach var="attribute" items="${attributes}">
					<tr>
						<td>${attribute.attribute.attributesName}</td>
						<td>${attribute.atrributeValue}</td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
