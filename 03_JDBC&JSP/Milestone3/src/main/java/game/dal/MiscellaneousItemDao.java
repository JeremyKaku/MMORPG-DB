...
public class MiscellaneousItemDao {
	...
	public MiscellaneousItem create(MiscellaneousItem misItem) throws SQLException  {
		String insertMisItem =
				"INSERT INTO miscellaneous_item(item_id,item_description) " +
				"VALUES(?,?);";
	...
	public MiscellaneousItem getConsumableItemByID(int itemID) throws SQLException {
		String selectMisItem =
				"SELECT m.item_id,i.item_name as item_name,i.max_stack_size as max_stack_size,i.vendor_price as vendor_price,m.item_description as item_description " +
				"FROM miscellaneous_item m INNER JOIN Item i " +
			...
			try {
				...
				if(results.next()) 
				{
					...
					MiscellaneousItem misItem = new MiscellaneousItem(itemID,resultItemName,resultMaxStackSize,resultVendorPrize,resultItemDes);
					return misItem;
				}
			} catch (SQLException e) {
				e.printStackTrace();
	...
	public MiscellaneousItem updateItemDescription(MiscellaneousItem misItem, String newItemDescription) throws SQLException {
