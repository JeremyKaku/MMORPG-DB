...
public class GearBonusDao {
    ...
    public GearBonus create(GearBonus gearBonus) throws SQLException {
        String insertGearBonus =
                "INSERT INTO gear_bonus(item_id, attribute_id, bonus_value) VALUES(?,?,?);";
    ...
    public GearBonus getGearBonusByID(int itemId, int attributeId) throws SQLException {
        String selectGearBonus =
                "SELECT item_id, attribute_id, bonus_value FROM gear_bonus WHERE item_id=? AND attribute_id=?;";
        Connection connection = null;
    ...
    public GearBonus delete(GearBonus gearBonus) throws SQLException {
        String deleteGearBonus =
                "DELETE FROM gear_bonus WHERE item_id=? AND attribute_id=?;";
        Connection connection = null;
