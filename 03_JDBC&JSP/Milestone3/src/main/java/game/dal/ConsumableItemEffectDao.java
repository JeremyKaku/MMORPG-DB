...
public class ConsumableItemEffectDao {
	...
	public ConsumableItemEffect create(ConsumableItemEffect consumableItemEffect) throws SQLException  {
		String insertCSEffect =
				"INSERT INTO consumable_item_effect(item_id,attribute_id,effect_percentage,max_effect_value) " +
				"VALUES(?,?,?,?);";
...
//					String resultAttributeName = results.getString("attribute_name");
					...
					ConsumableItemEffect consumableItemEffect = new ConsumableItemEffect(consumableItem, attribute,resultEffectPercentage,resultMaxEffectValue);
					return consumableItemEffect;
				}
			} catch (SQLException e) {
				e.printStackTrace();
