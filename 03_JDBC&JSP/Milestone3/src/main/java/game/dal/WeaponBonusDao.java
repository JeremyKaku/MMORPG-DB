...
public class WeaponBonusDao {
    ...
    public WeaponBonus create(WeaponBonus weaponBonus) throws SQLException {
        String insertWeaponBonus =
                "INSERT INTO weapon_bonus(item_id, attribute_id, bonus_value) VALUES(?,?,?);";
    ...
    public WeaponBonus getWeaponBonusByID(int itemId, int attributeId) throws SQLException {
        String selectWeaponBonus =
                "SELECT item_id, attribute_id, bonus_value FROM weapon_bonus WHERE item_id=? AND attribute_id=?;";
        Connection connection = null;
    ...
    public WeaponBonus delete(WeaponBonus weaponBonus) throws SQLException {
        String deleteWeaponBonus =
                "DELETE FROM weapon_bonus WHERE item_id=? AND attribute_id=?;";
        Connection connection = null;
