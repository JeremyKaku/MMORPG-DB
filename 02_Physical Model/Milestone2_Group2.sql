...
(1,'Jing Guo','guo.jing2@northeastern.edu',SHA2('password123', 256)),
(2,'Xue Han','han.xue2@northeastern.edu',SHA2('password123', 256)),
(3,'Riddhi Gohil','gohil.r@northeastern.edu',SHA2('password123', 256)),
(4,'Yashvi Garg','garg.yas@northeastern.edu',SHA2('password123', 256)),
(5,'Gaurav Jurani','jurani.g@northeastern.edu',SHA2('password123', 256));
...
(1,645,90,128,119.46,2.80,NULL),
(2,630,90,125,126.66,3.04,NULL),
(3,1,90,9,9.36,3.12,NULL),
(4,31,30,37,35.52,2.88,NULL),
(5,510,80,103,107.12,3.12,NULL);
...
(6,645,1,90,1267,1267,NULL),
(7,660,2,90,624,491,NULL),
(8,660,3,90,837,658,NULL),
(9,660,4,90,624,491,NULL),
(10,660,5,90,837,658,NULL),
(11,660,6,90,624,491,NULL),
(12,660,7,90,1,1,NULL),
(13,660,8,90,1,1,NULL),
(14,660,9,90,1,1,NULL),
(15,660,10,90,1,1,NULL),
(16,30,11,30,0,0,NULL);
...
(1,	'Cloud','Strife',1,1),
(2,	'Tifa','Lockhart',2,2),
(3,	'Aerith','Gainsborough',3,3),
(4,	'Yuffie','Kisaragi',4,4),
